<?php 
    ...
    class Screening {
        ...
        public function getId_movie_screening() { return $this->id_movie_screening; }

        public function setId_movie_screening($id_movie_screening) { $this->id_movie_screening = $id_movie_screening; }

        public function getId_cinema_screening() { return $this->id_cinema_screening; }

        public function setId_cinema_screening($id_cinema_screening) { $this->id_cinema_screening = $id_cinema_screening; }
